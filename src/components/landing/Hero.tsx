  ...
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-32 top-20 h-80 w-80 rounded-full bg-violet-200/30 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 pb-20 pt-16 lg:grid-cols-2 lg:pt-24">
        <div className="text-center lg:text-left">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row lg:justify-start">
            <Link
              href="/builder"
              className="group inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-8 py-4 text-base font-semibold text-white shadow-xl shadow-indigo-200 transition hover:bg-indigo-700 sm:w-auto"
            >
